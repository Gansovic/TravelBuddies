...
export class CollaborationService {
   ...
   */
  async broadcastCaptureEvent(tripId: string, event: MomentCaptureEvent): Promise<void> {
   ...
   */
  async updateCaptureStatus(tripId: string, isCapturing: boolean, captureType?: string): Promise<void> {
    if (!this.supabase || !this.currentUserId) return;
   ...
   */
  async sendTypingIndicator(tripId: string, isTyping: boolean): Promise<void> {
    if (!this.supabase || !this.currentUserId) return;
   ...
   */
  private async logActivity(tripId: string, activityType: string, targetId?: string): Promise<void> {
    if (!this.supabase || !this.currentUserId) return;
   ...
   */
  private handlePresenceUpdate(tripId: string, presenceState: any): void {
   ...
   * Handle user joined
   */
  private handleUserJoined(tripId: string, userId: string, presence: any): void {
   ...
   * Handle user left
   */
  private handleUserLeft(tripId: string, userId: string): void {
