...
describe('NumberFormatters', () => {
  describe('formatPoints', () => {
    ...
    it('should handle invalid inputs', () => {
      ...
      expect(NumberFormatters.formatPoints(null as any)).toBe('0 pts');
      expect(NumberFormatters.formatPoints(undefined as any)).toBe('0 pts');
    });
  });
  ...
  describe('formatDistance', () => {
    ...
    it('should handle invalid inputs', () => {
      ...
      expect(NumberFormatters.formatDistance(null as any)).toBe('0 m');
    });
  });
