 ...
 */
export async function validateFile(filePath: string, config: Config, content?: string): Promise<ValidationResult> {
 ...
 */
async function validateLeverFramework(
  filePath: string, 
  content: string, 
  ast: any, 
  config: Config
 ...
 * L - Leverage Existing Patterns
 */
function validateLeveragePatterns(filePath: string, content: string, ast: any, config: Config): Violation[] {
  const violations: Violation[] = [];
 ...
 * E - Extend Before Creating
 */
function validateExtendBeforeCreating(filePath: string, content: string, ast: any, config: Config): Violation[] {
  const violations: Violation[] = [];
 ...
 * V - Verify Through Reactivity
 */
function validateReactivePatterns(filePath: string, content: string, ast: any, config: Config): Violation[] {
  const violations: Violation[] = [];
 ...
 * E - Eliminate Duplication
 */
function validateDuplicationElimination(filePath: string, content: string, ast: any, config: Config): Violation[] {
  const violations: Violation[] = [];
  ...
  const stringLiterals: string[] = stringLiteralsMatch || [];
 ...
 * R - Reduce Complexity
 */
function validateComplexityReduction(filePath: string, content: string, ast: any, config: Config): Violation[] {
  const violations: Violation[] = [];
 ...
 */
async function validateTechnicalRules(
  filePath: string, 
  content: string, 
  ast: any, 
  config: Config
 ...
 */
function validateSingletonPattern(filePath: string, content: string, config: Config): Violation[] {
  const violations: Violation[] = [];
 ...
 */
function validateSecurity(filePath: string, content: string, config: Config): Violation[] {
  const violations: Violation[] = [];
 ...
 */
function validateErrorHandling(filePath: string, content: string, config: Config): Violation[] {
  const violations: Violation[] = [];
 ...
 */
function validateDocumentation(filePath: string, content: string, config: Config): Violation[] {
  const violations: Violation[] = [];
 ...
 */
async function validateFileOrganization(filePath: string, content: string, config: Config): Promise<Violation[]> {
  const violations: Violation[] = [];
 ...
 */
function validateNamingConventions(filePath: string, content: string, config: Config): Violation[] {
  const violations: Violation[] = [];
 ...
 */
function validateDirectoryStructure(filePath: string, config: Config): Violation[] {
  const violations: Violation[] = [];
 ...
 */
async function validatePatterns(filePath: string, content: string, config: Config): Promise<Violation[]> {
  const violations: Violation[] = [];
  ...
  for (const forbidden of config.forbiddenPatterns) {
    ...
    const isException = forbidden.exceptions.some(pattern => 
      matchesPattern(filePath, pattern, config.paths.projectRoot)
    );
