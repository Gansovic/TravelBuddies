 ...
 */
export function parsePrinciplesFile(principlesPath: string): any {
 ...
 */
function extractExistingPatterns(content: string): string[] {
 ...
 */
function extractForbiddenExamples(content: string): string[] {
 ...
 */
export function parseFile(filePath: string, content?: string): any {
  try {
 ...
 */
export function getFilesToValidate(config: Config, specificFiles?: string[]): string[] {
 ...
 */
export function shouldIgnoreFile(filePath: string, config: Config): boolean {
 ...
 */
export function normalizeFilePath(filePath: string, config: Config): string {
  const projectRootDir = config.paths.projectRoot ? resolve(process.cwd(), config.paths.projectRoot) : process.cwd();
 ...
 */
export function matchesPattern(filePath: string, pattern: string, projectRoot?: string): boolean {
 ...
 */
export function formatViolation(violation: Violation, config: Config): string {
 ...
 */
export function printResults(result: ValidationResult, config: Config): void {
  const { colorOutput } = config.general;
