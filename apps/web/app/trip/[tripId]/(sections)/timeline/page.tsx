...
/**
 * Timeline Redirect Page - Redirects to Memories
 * Timeline and Memories sections have been unified
 */
export default function TripTimelineRedirect({ params }: TripTimelinePageProps) {
